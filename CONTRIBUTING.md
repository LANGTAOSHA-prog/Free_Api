...
*Please follow the guidelines given below while making a Pull Request to the Free Public APIs*
...
* Target your Pull Request to the `master` branch of `Free Public APIs`
